...
CREATE TABLE controle_conservacao.medicoes (
    ...
    fator_reajuste              NUMERIC(10,4) NOT NULL DEFAULT 0, 
    valor_reajuste              NUMERIC(16,2) NOT NULL DEFAULT 0,
    valor_ref_glosa             NUMERIC(16,2) NOT NULL DEFAULT 0,
    valor_ajuste_contratual     NUMERIC(16,2) NOT NULL DEFAULT 0,
    valor_processo              NUMERIC(16,2) NOT NULL DEFAULT 0,
...
(2 ,'#20b2aa' ,'APD' ,'Abrir Padrão'     ,'Quando a Medição é referente ao periodo Ativo.'),
...
(3 ,'#fd0009' ,'AAS' ,'Aguardando Assinaturas'   ,'Medição Validada pelo fiscal mas ainda com assinaturas pendentes.'),
...
(0 ,'#f0af09' ,'ANE' ,'Ainda Não Encaminhado'         ,'Medição com status fisico ainda não encaminhada para o financeiro.'),
(1 ,'#f0af09' ,'ACL' ,'Aguardando Classificação'      ,'Medição de Valor encaminhada para financeiro ainda não classificada.'),
(2 ,'#f50a15' ,'APE' ,'Aguardando Pendencias'         ,'Medição foi classificada mais esta aguardando resolver pendencias.'),
...
(12 ,'Medicao Liberada p/ Protocolar'),
